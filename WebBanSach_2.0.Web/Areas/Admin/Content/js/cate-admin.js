...
function ajaxData(pageNum, sstring) {
    ...
    $("#paged").empty();
    $.ajax({
        url: "/Admin/Category/GetPaggedData",
        type: "get",
        dataType: "json",
            ...
            if (response.status == true) {
                ...
                for (var i = 0; i < data.Items.length; i++) {
                    ...
                    rowData += `<td>
                            ...
                            <button class="btn btn-outline-light open-delete-modal" data-id="${data.Items[i].ID}" data-name="${data.Items[i].CategoryName}">
